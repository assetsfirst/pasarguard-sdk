...
------------ | ------------- | ------------- | -------------
**mem_total** | **number** |  | [default to undefined]
**mem_used** | **number** |  | [default to undefined]
**cpu_cores** | **number** |  | [default to undefined]
...
```typescript
import { ResponseRealtimeNodesStatsApiNodesRealtimeStatsGetValue } from './api';

const instance: ResponseRealtimeNodesStatsApiNodesRealtimeStatsGetValue = {
    mem_total,
    mem_used,
    cpu_cores,
    cpu_usage,

...
// @ts-ignore
import type { RealityScanRequest } from '../models';
// @ts-ignore
import type { RealityScanResult } from '../models';
// @ts-ignore
...
export const CoreApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllCores: async (ids?: Array<number> | null, offset?: number | null, limit?: number | null, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getCoresSimple: async (ids?: Array<number> | null, offset?: number | null, limit?: number | null, search?: string | null, sort?: string | null, all?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {RealityScanRequest} realityScanRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        scanRealityTarget: async (realityScanRequest: RealityScanRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'realityScanRequest' is not null or undefined
            assertParamExists('scanRealityTarget', 'realityScanRequest', realityScanRequest)
            const localVarPath = `/api/core/reality-scan`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(realityScanRequest, localVarRequestOptions, configuration)
...
export const CoreApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllCores(ids?: Array<number> | null, offset?: number | null, limit?: number | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoreResponseList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllCores(ids, offset, limit, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async getCoresSimple(ids?: Array<number> | null, offset?: number | null, limit?: number | null, search?: string | null, sort?: string | null, all?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CoresSimpleResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCoresSimple(ids, offset, limit, search, sort, all, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async scanRealityTarget(realityScanRequest: RealityScanRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RealityScanResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.scanRealityTarget(realityScanRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CoreApi.scanRealityTarget']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const CoreApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAllCores(ids?: Array<number> | null, offset?: number | null, limit?: number | null, options?: RawAxiosRequestConfig): AxiosPromise<CoreResponseList> {
            return localVarFp.getAllCores(ids, offset, limit, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a core configuration by its ID.
         * @summary Get Core Config
         ...
         * @throws {RequiredError}
         */
        getCoresSimple(ids?: Array<number> | null, offset?: number | null, limit?: number | null, search?: string | null, sort?: string | null, all?: boolean, options?: RawAxiosRequestConfig): AxiosPromise<CoresSimpleResponse> {
            return localVarFp.getCoresSimple(ids, offset, limit, search, sort, all, options).then((request) => request(axios, basePath));
        },
        /**
         * Update an existing core configuration.
         * @summary Modify Core Config
         ...
         * @throws {RequiredError}
         */
        scanRealityTarget(realityScanRequest: RealityScanRequest, options?: RawAxiosRequestConfig): AxiosPromise<RealityScanResult> {
            return localVarFp.scanRealityTarget(realityScanRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CoreApi extends BaseAPI {
     ...
     * @memberof CoreApi
     */
    public getAllCores(ids?: Array<number> | null, offset?: number | null, limit?: number | null, options?: RawAxiosRequestConfig) {
        return CoreApiFp(this.configuration).getAllCores(ids, offset, limit, options).then((request) => request(this.axios, this.basePath)).then(({data}) => data);
    }
     ...
     * @memberof CoreApi
     */
    public getCoresSimple(ids?: Array<number> | null, offset?: number | null, limit?: number | null, search?: string | null, sort?: string | null, all?: boolean, options?: RawAxiosRequestConfig) {
        return CoreApiFp(this.configuration).getCoresSimple(ids, offset, limit, search, sort, all, options).then((request) => request(this.axios, this.basePath)).then(({data}) => data);
    }
     ...
     * @memberof CoreApi
     */
    public scanRealityTarget(realityScanRequest: RealityScanRequest, options?: RawAxiosRequestConfig) {
        return CoreApiFp(this.configuration).scanRealityTarget(realityScanRequest, options).then((request) => request(this.axios, this.basePath)).then(({data}) => data);
    }
}
